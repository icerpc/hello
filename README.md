...
| [Slice Stream](./src/slice/Generator.slice)    | `/StreamExample.Generator`  | A service that streams data           | [C# Stream](https://github.com/icerpc/icerpc-csharp/tree/0.3.x/examples/slice/Stream/Client)                                                                                                    |
